...
public class Chain : MonoBehaviour
{
    ...
    void InBetwenCalculation()
    {
        ...
        for (int i = 0; i < chainObjects.Length; i++)
        {
            ...
            if(i != 0 && i != chainObjects.Length - 1)
            {
                ...
                // do calcul for gravity
                //Debug.Log(localDistance.magnitude + " " + i);
            ...
            if(i != 0 && i != chainObjects.Length - 1)
            {
                ...
                {
                   // Debug.Log(chainObjects[1].transform.eulerAngles);
    ...
    // add delay... somehow
    // distance clamp to not have overlap... a little bit (maybe it will do it automaticelly with the physic)
    //tension change when attacking 
